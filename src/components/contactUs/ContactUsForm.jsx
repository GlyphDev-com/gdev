        ...
        <div className="gdev-field-wrapper">
          <div className="capsule">
            ...
            <textarea
              ...
              id="message"
              className="py-4 height-150 border-t-0  border-l-0 border-r-0 br-0 border-secondary"
              name="message"
...
<button type="submit" className="btn lift-3 btn-primary px-4">Envoyer</button>
